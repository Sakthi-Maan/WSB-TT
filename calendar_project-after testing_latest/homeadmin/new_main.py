            ...
            while True:
                ...
                if audio_data:
                    for audio_item in audio_data:
                        bell_path = audio_item.get('bell_path',     '')
                        paalpath = audio_item.get('paalpath',       '')
                        adhikaram_path = audio_item.get('adhikaram_path', '')
                        thirukkural_path = audio_item.get(
                            'thirukkural_path', '')
                        new_audio = audio_item.get('audio', '')

                        # Create a list of audio paths that are not empty
                        audio_paths = [path for path in [bell_path, paalpath, adhikaram_path, thirukkural_path , new_audio] if path]
                        print(
