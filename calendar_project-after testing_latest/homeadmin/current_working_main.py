...
def run_worker1():
    Worker1 = BCDThumbwheel()  # Assuming BCDThumbwheel is defined elsewhere
    Worker1.main()

def run_worker2(dir_path, thirukkural_api):
    Worker2 = AudioPlayer(dir_path, thirukkural_api)  # Assuming AudioPlayer is defined elsewhere
    Worker2.main()

def run_worker0(api_url):
    Worker0 = ApiManager(api_url)  # Assuming ApiManager is defined elsewhere
    Worker0.main()
...
if __name__ == "__main__":
    ...
    thread2 = threading.Thread(target=run_worker2, args=(dir_path, thirukkural_api))
